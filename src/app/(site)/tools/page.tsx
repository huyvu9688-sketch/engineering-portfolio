...
const TOOLS: {
  ...
  },
  {
    ...
    desc: "Drop a GLB or GLTF model to inspect an assembly in 3D — walk the component tree, isolate a part, and measure between points. Read locally; nothing is uploaded.",
  },
  {
