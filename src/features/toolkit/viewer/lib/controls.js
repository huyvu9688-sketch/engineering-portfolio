// View controls: isolate, show-all, focus, reset camera, persistent selection.
...
export class ViewerControls {
    ...
    /** Persistently glow a part (accent), clearing any previous selection. */
    selectPart(node) {
    ...
    showAllParts(recordHistory = true) {
        ...
        if (recordHistory) previousHiddenParts = Array.from(this.componentList.hiddenParts);
